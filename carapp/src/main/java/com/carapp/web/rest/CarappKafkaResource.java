...
@RestController
@RequestMapping("/api/carapp-kafka")
public class CarappKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CarappKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CarappKafkaResource(KafkaProperties kafkaProperties) {
